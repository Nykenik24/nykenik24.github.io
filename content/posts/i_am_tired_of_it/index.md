...
Last sunday I was peacefully starting the development of my latest "project": Kill the queen. Remember [this post](/posts/another_idea), where I talk about this game I was going to make? Well, you probably know where this went.
...
_Yes, my device name is `iusearchbtw`, sorry for that._
...
Instead of just `rm -rf`ing them, I zip them and store them there. So, 669MB of abandoned projects across **18 project archives**. By the way, these are not all projects I abandoned, just the ones I archived.
...
And, being honest, I hate abandoning projects _a lot_.

It might seem counterintuitive: like, if I hate it so much, then why do I still abandon so many projects? And, I will answer with a simple:
...
If we look into development you _can_ see some obvious patterns (although I am the only person that actually knows how development of these went, so don't think you were going to find them lmao):
...
- I will upload it to my brother's _Forgejo_ because I hate AI and don't want it to train on my code, so no GitHub.
- I will probably make it in C, and if that doesn't work then let's see what I do.
- As I didn't post last week, next two days (Friday 5/12 and Saturday 6/12) will be dedicated to research and design, and Sunday I will share what I did as a devlog in it's own [project section](/projects/).
